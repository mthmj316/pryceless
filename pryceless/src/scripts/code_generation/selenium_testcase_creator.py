...
def create_unit_test_tag_name(tag_id, expected_tag_name):
    ...
    test_case_content.append(create_assert_equals('"' + expected_tag_name + '"','tag.getTagName()', 'tag name'))
...
'''
    Converts the given tag_id to the name which is inserted in the testcase method.
